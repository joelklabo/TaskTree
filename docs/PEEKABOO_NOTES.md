...
- Trace artifacts: set `TASKTREE_TRACE_RUN_ID` to also copy captures into `backend/tasktree/agents/trace/runs/<run-id>/artifacts/peekaboo/` (override the root via `TASKTREE_TRACE_ROOT` when needed).
